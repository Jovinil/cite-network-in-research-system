          ...
          <!--begin::Sidebar Menu-->
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
              <!--admin sidebar-->
                ...
                <li class="nav-item">
                  <a href="#" class="nav-link"><p>Employee List</p></a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link"><p>Employee Weekly Report</p></a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link"><p>OJT Coordinator Info</p></a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link"><p>Employer Info</p></a>
                </li>
