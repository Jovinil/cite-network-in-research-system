        ...
        <div class="card">
            <div class="card-body register-card-body">
                ...
                <form action="../index3.html" method="post">
                    <div class="input-group mb-3"> <input type="text" class="form-control" placeholder="First Name" name="first_name">
                        <div class="input-group-text"> <span class="bi bi-person"></span> </div>
                    </div>
                    <div class="input-group mb-3"> <input type="text" class="form-control" placeholder="Last Name" name="last_name">
                        <div class="input-group-text"> <span class="bi bi-person"></span> </div>
                    </div>
